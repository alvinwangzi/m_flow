...
**更新** 本次更新反映了测试基础设施的建立，新增了针对 Kuzu 图数据库查询属性和自定义嵌入提供程序配置的单元测试，进一步完善了测试金字塔的覆盖范围。
...
**更新** 新增的测试基础设施进一步强化了单元测试和集成测试的覆盖范围，特别是在图数据库和嵌入配置方面。
...
**更新** 本次更新显著增强了测试基础设施，新增的 Kuzu 图数据库测试和嵌入配置测试进一步完善了测试覆盖范围，特别是在图查询属性和自定义嵌入提供程序方面。这些测试确保了增强功能的正确性和性能表现，为系统的稳定运行提供了有力保障。
